...
define(['./workbox-6d565866'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "/index.html",
    "revision": "0.1fv0ksrt81g"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/wp-json/, /^https:\/\/erpos\.tekrabyte\.id\/wp-json/]
  }));
  workbox.registerRoute(/^https:\/\/erpos\.tekrabyte\.id\/wp-json\/.*/i, new workbox.NetworkFirst({
